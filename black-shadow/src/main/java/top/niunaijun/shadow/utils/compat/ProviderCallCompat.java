package top.niunaijun.shadow.utils.compat;
 ...
 * 此处无Bug
 */
public class ProviderCallCompat {
    public static Bundle callSafely(String authority, String methodName, String arg, Bundle bundle) {
        try {
            return call(authority, BlackShadow.getContext(), methodName, arg, bundle, 5);
    ...
    public static final class Builder {
        ...
        public Bundle call() throws IllegalAccessException {
            return ProviderCallCompat.call(auth, context, method, arg, bundle, retryCount);
        }
